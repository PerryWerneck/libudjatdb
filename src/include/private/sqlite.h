 ...
 namespace Udjat {
	...
	namespace SQL {
		...
		private:
			...
			sqlite3_stmt * prepare(const SQL::Statement::Script &script);
			void bind(const SQL::Statement::Script &script, sqlite3_stmt *stmt, const Abstract::Object &request, Udjat::Value &response);
