 ...
 */
 ...
 namespace Udjat {
	...
	sqlite3_stmt * SQL::Session::prepare(const SQL::Script::_Script &script) {
	...
	void SQL::Session::bind(const SQL::Script::_Script &script, sqlite3_stmt *stmt, const Abstract::Object &request, Udjat::Value &response) {
	...
	void SQL::Session::bind(const SQL::Script::_Script &script, sqlite3_stmt *stmt, Udjat::Value &response) {
	...
	void SQL::Session::exec(const std::vector<SQL::Script::_Script> &scripts, const Abstract::Object &request, Udjat::Value &response) {
	...
	void SQL::Session::exec(const std::vector<SQL::Script::_Script> &scripts, Udjat::Value &response) {
	...
	void SQL::Session::exec(const std::vector<SQL::Script::_Script> &scripts, const Request &request, Udjat::Value &response) {
	...
	void SQL::Session::exec(const std::vector<SQL::Script::_Script> &scripts, const Request &request, Udjat::Response::Table &response) {
